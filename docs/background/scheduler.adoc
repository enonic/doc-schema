...
== Configuration
There are two ways to configure custom scheduled jobs: <<../libraries/lib-scheduler#, lib>> API provides methods to manipulate jobs and <<../deployment/config#scheduler, config>> file is used to configure default permanent cron jobs.
