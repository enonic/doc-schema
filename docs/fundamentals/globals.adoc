...
The globally available ``exports`` keyword is used to expose functionality from a given module (implementations, libraries, etc.). This is part of the CommonJS module spec.
