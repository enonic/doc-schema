...
Admin extensions are app-provided HTTP endpoints that mount into existing <<tools#,admin tools>> at named interface points. (previously known as *widgets*).
...
See <<extensions/preview-widgets#,Preview widgets>> for a worked example: the `contentstudio.liveview` interface published by Content Studio.
