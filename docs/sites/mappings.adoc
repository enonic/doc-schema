...
`component`:: Maps requests to contextual page components at `+/_/component/<component-path>+`. The full URL is `+<host>:<port>/site/<repo>/<branch>/<path-to-page>/_/component/<component-path>+`.
