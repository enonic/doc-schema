...
Create a response processor by placing a controller file in your project folder under `src/main/resources/cms/processors/` i.e. `src/main/resources/cms/processors/myprocessor.js`.
...
<1> *name* indicates the name of the controller file (without the `.js` extension).
