...
They have the same capabilities as regular <<../framework/http#, HTTP functions>>, you may take advantage of <<contributions#, page contributions>>, and the fact that they are always executed in the context of a content item.
...
API functions such as <<../libraries/lib-portal#getContent, portalLib.getContent()>>, and <<../libraries/lib-portal#getComponent, portalLib.getComponent()>> will automatically return values based on the context.
...
Page controllers must be placed next to your <<../cms/pages#, page descriptor>> i.e. `src/main/resources/cms/pages/<page-name>/<page-name>.js`.
...
Part controllers must be placed next to your <<../cms/pages/parts#, part descriptor>> i.e. `src/main/resources/cms/parts/<part-name>/<part-name>.js`.
...
Layout controllers must be placed next to your <<../cms/pages/layouts#, layout descriptor>> i.e. `src/main/resources/cms/layouts/<layout-name>/<layout-name>.js`.
