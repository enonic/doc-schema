...
CMS/Sites::  Use the <<../libraries/lib-i18n#,the localization API>> to dynamically localize any text phrases in your app. The framework will attempt to apply the locale specified in the site's language property.
...
Webapps and more:: The <<../libraries/lib-i18n#,the localization API>> may also be used for any other purpose. In these cases, the developer must control and explicitly specify locale.
