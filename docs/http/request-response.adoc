...
An HTTP function is a <<../fundamentals/functions#, function>> that responds to an HTTP request. The file where it lives is invoked by one of XP's engines (webapp, site, API) based on URL routing defined in descriptors or path conventions.
