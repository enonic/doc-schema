...
ID providers are wired tightly into the <<../http#common_request_pipeline, common HTTP request pipeline>>.
...
The URL to the endpoint can be generated using the <<../libraries/lib-portal#_loginurl, loginUrl() function in the portal library>>
...
The URL for this endpoint can be generated using the <<../libraries/lib-portal#_logouturl, logoutUrl() function in the portal library>>
...
Additionally, an ID provider may also act as a regular <<../http/request-response#, HTTP function>> — supporting any interaction as desired.
Communication with the implementation is handled via the ID provider endpoint.

The URL to this endpoint can be generated using the <<../libraries/lib-portal#_idproviderurl, idProviderUrl() function in the portal library>>
