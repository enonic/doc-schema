...
Mappings are the first custom processing step in the <<site#, site service>>. Mappings execute before the component rendering. You may define mappings for both <<../../http/request-response#, HTTP functions>> and <<../../http/filters#, filters>>. The use cases are vast.
